...
/**
 * Provides the local service interface for Conversacion. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ConversacionLocalServiceUtil
...
public interface ConversacionLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link ConversacionLocalServiceUtil} to access the conversacion local service. Add custom service methods to {@link com.proyecto.quental.chat.service.impl.ConversacionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
