...
import com.proyecto.quental.chat.service.ConversacionLocalService;
...
/**
 * Provides the base implementation for the conversacion local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.proyecto.quental.chat.service.impl.ConversacionLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class ConversacionLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements ConversacionLocalService,
        IdentifiableBean {
    ...
    private ConversacionLocalServiceClpInvoker _clpInvoker = new ConversacionLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link com.proyecto.quental.chat.service.ConversacionLocalServiceUtil} to access the conversacion local service.
     */
    ...
    public Conversacion addConversacion(Conversacion conversacion)
        ...
        return conversacionPersistence.update(conversacion);
    }
     ...
     */
    @Override
    public Conversacion createConversacion(long conversacionId) {
        return conversacionPersistence.create(conversacionId);
    }
    ...
    @Override
    public Conversacion deleteConversacion(long conversacionId)
        throws PortalException, SystemException {
        return conversacionPersistence.remove(conversacionId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Conversacion deleteConversacion(Conversacion conversacion)
        throws SystemException {
        return conversacionPersistence.remove(conversacion);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(Conversacion.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return conversacionPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return conversacionPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public Conversacion fetchConversacion(long conversacionId)
        throws SystemException {
        return conversacionPersistence.fetchByPrimaryKey(conversacionId);
    }
     ...
     */
    @Override
    public Conversacion getConversacion(long conversacionId)
        throws PortalException, SystemException {
        return conversacionPersistence.findByPrimaryKey(conversacionId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return conversacionPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<Conversacion> getConversacions(int start, int end)
        throws SystemException {
        return conversacionPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getConversacionsCount() throws SystemException {
        return conversacionPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Conversacion updateConversacion(Conversacion conversacion)
        throws SystemException {
        return conversacionPersistence.update(conversacion);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("com.proyecto.quental.chat.model.Conversacion",
            conversacionLocalService);
    }
